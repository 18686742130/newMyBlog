...
<div class="MainForm" id="login_page">
  <form id="frm_login" action="user/checkLogin" method="POST" style="float:left; width:620px;">
    <h2>登录个人博客，如果尚未加入的请点击<a href="user/register">注册新会员</a></h2>
    <div id="error_msg" class="error_msg" style="display:none;"></div>
    <table>
    	<tbody><tr>
    		<th nowrap="nowrap">邮箱 或 账号：</th>
    		<td><input name="name" id="f_email" class="TEXT" style="width: 200px;" type="text"></td>
    	</tr>
    	<tr>
    		<th>登录密码：</th>
